...
export function Join() {
  ...
  return (
    <section id="join" className="py-32 px-4 sm:px-6 lg:px-8 relative bg-gradient-to-b from-card/20 to-background">
      <div className="max-w-7xl mx-auto">
        <div className="text-center mb-20">
          ...
          <p className="text-lg text-foreground/60 max-w-3xl mx-auto leading-relaxed">
            Become part of Hofstra's quantum computing community and shape the future of technology
          </p>
        </div>

        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
          <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-8">
            <h3 className="text-2xl font-semibold text-foreground mb-6">Sign Up for Updates</h3>
            ...
            {!submitted ? (
              ...
              <div className="text-center py-12">
                ...
                <h4 className="text-xl font-semibold text-foreground mb-2">Thanks for joining!</h4>
                <p className="text-foreground/60">We'll be in touch soon with club updates.</p>
              </div>
            )}
          </div>
          ...
          <div className="space-y-6">
            <div className="bg-card/50 backdrop-blur-sm border border-border rounded-2xl p-8 text-center hover:bg-card hover:scale-105 transition-all duration-300">
              <h3 className="text-2xl font-semibold text-primary mb-4">Scan to Join</h3>
              <div className="bg-white rounded-xl p-6 inline-block mb-4">
                <img src="/qr-code.png" alt="QR Code to join HQCC" className="w-48 h-48" />
              </div>
              <p className="text-foreground/60">Scan with your phone to quickly access our signup form</p>
            </div>
      ...
      <footer className="mt-24 text-center">
        <div className="bg-card/50 backdrop-blur-sm border border-border rounded-xl p-6 inline-block">
          <p className="text-foreground/60 mb-2">© 2025 Hofstra Quantum Computing Club</p>
          <p className="text-foreground/50 text-sm">Shaping the future, one qubit at a time</p>
        </div>
      </footer>
    </section>
  )
