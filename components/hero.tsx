    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden">
      ...
      <div className="relative z-10 max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-20">
        ...
        <h1 className="text-5xl sm:text-7xl lg:text-8xl font-bold tracking-tight mb-6 text-balance">
          ...
          <span className="block text-4xl sm:text-5xl lg:text-6xl bg-gradient-to-r from-primary via-accent to-secondary bg-clip-text text-transparent animate-gradient">
