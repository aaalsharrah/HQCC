...
// Export dynamicParams to allow dynamic routes in static export
...
export default function ChatPage() {
  ...
  useEffect(() => {
    if (typeof window !== 'undefined') {
      // Get ID from URL path (Next.js dynamic route)
  ...
  if (!conversation) {
    ...
    const otherUser = otherUserId ? { uid: otherUserId, email: null as string | null, avatar: null as string | null, name: null as string | null } : null
