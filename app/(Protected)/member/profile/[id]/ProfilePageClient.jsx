      ...
      (async () => {
        try {
          ...
          if (!snap.exists()) {
            ...
            const website = data.website || 'hqcc.hofstra.edu';
            let github = data.github || '';

            // Fallback: if old profiles stored GitHub in website
            if (
              !github &&
          ...
          <TabsContent value="likes" className="space-y-6">
            {!isCurrentUserProfile ? (
              <Card className="p-12 text-center bg-card/50 backdrop-blur-xl border-border/50">
                ...
                <p className="text-muted-foreground">
                  You can only see your own liked posts.
                </p>
              </Card>
            ) : !likedPostsLoaded ? (
              <Card className="p-12 text-center bg-card/50 backdrop-blur-xl border-border/50">
